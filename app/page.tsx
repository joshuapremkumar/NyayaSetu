    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="border-b border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-xl text-foreground">NyayaSetu AI</span>
          </div>
      ...
      <section id="features" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">Why NyayaSetu AI</h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-400 text-lg mb-6 leading-relaxed">
                NyayaSetu AI is designed from the ground up for government and judicial operations. Our platform combines cutting-edge AI with rigorous governance standards to deliver a solution that legal professionals can trust.
              </p>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 text-center">
          ...
          <p className="text-blue-100 mb-8 text-lg max-w-2xl mx-auto">
            Start with NyayaSetu AI today and get institutional-grade decision support for your legal operations.
          </p>
          <Link href="/dashboard">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="font-bold text-xl text-white">NyayaSetu AI</span>
            </div>
